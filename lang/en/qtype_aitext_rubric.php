...
$string['aifeedbackforgrader'] = 'AI-generated feedback (shown to students until you save your own comment below)';
$string['aifeedbackforgrader_help'] = 'This is the feedback automatically generated by AI. It is shown here as a reference for the grader. Students will only see it as far as you do not save a comment. It is also used as the starting point for your own feedback. You can edit it and save it as your own comment.';
...
$string['err_rubricandmarkscheme'] = 'A rubric and a mark scheme are mutually exclusive; clear one of them.';
$string['err_rubricinvalid'] = 'The rubric is not valid: {$a}';
...
$string['quizsettingsheader'] = 'AI text questions';
...
$string['rubric'] = 'Rubric (JSON)';
$string['rubric_ailabel'] = 'AI:';
$string['rubric_badge_met'] = 'met';
$string['rubric_badge_missed'] = 'not met';
$string['rubric_badge_partial'] = 'partly';
$string['rubric_banner'] = 'The assessment below was made automatically by an AI model ({$a}). It can be wrong. If you disagree with it, you are probably right — ask your teacher.';
$string['rubric_evidencelabel'] = 'Based on:';
$string['rubric_gradingfailed'] = 'The automatic assessment did not succeed this time. Your answer has been saved and your teacher will look at it.';
$string['rubric_help'] = 'A criterion-referenced rubric as JSON: {"language": "fi", "display": "fine", "criteria": [{"id": "slug", "title": "…", "levels": ["…", "…"]}]}. A level\'s index is the points it earns; the mark is the sum over criteria. When a rubric is set, it replaces the mark scheme and the AI prompt field is used as question-specific grading context.';
$string['rubric_nextlabel'] = 'Next:';
$string['rubric_nextsteplabel'] = 'Most useful improvement:';
$string['rubric_totallabel'] = 'Points:';
...
$string['scaffold'] = 'Answer skeleton';
$string['scaffold_help'] = 'A suggested structure for the answer (HTML), shown above the answer box while the student is answering when the scaffold level is "Skeleton shown". Purely presentational: the AI grader never sees it.';
$string['scaffoldlevel'] = 'Scaffold level';
$string['scaffoldlevel1'] = 'Skeleton shown above the answer box';
$string['scaffoldlevel2'] = 'No scaffold (plain answer box)';
$string['scaffoldlevel_help'] = 'Whether the answer skeleton is shown above the answer box. Each quiz can override this question default in its settings.';
$string['scaffoldquizdefault'] = 'Question default (no override)';
...
$string['spellchecktoggle'] = 'Spellcheck feedback';
